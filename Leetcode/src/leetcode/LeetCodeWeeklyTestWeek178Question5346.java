...
public class LeetCodeWeeklyTestWeek178Question5346 {
	...
	/**Method 1: DFS twice
	 * first DFS: find the start point on the TreeNode when TreeNode.val = head.val
	 * 			  store the start points in the list
	 * second DFS: match every node from the start point
	 * */
